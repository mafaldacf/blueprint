...
import (
	...
	"github.com/blueprint-uservices/blueprint/examples/coupons_app/workflow/coupons_app"
...
func makeDockerSpec(spec wiring.WiringSpec) ([]string, error) {
	...
	students_db := mongodb.Container(spec, "students_db")
	coupons_db := mongodb.Container(spec, "coupons_db")

	allServices = append(allServices, students_db)
	allServices = append(allServices, coupons_db)

	student_service := workflow.Service[coupons_app.StudentService](spec, "student_service", students_db)
	...
	coupon_service := workflow.Service[coupons_app.CouponService](spec, "coupon_service", coupons_db)
	...
	frontend := workflow.Service[coupons_app.Frontend](spec, "frontend", student_service, coupon_service)
