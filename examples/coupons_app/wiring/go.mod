module github.com/blueprint-uservices/blueprint/examples/coupons_app/wiring
...
require (
	...
	github.com/blueprint-uservices/blueprint/examples/coupons_app/workflow v0.0.0
)
...
replace github.com/blueprint-uservices/blueprint/examples/coupons_app/workflow => ../workflow
