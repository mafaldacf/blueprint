module github.com/blueprint-uservices/blueprint/examples/threechain2/wiring
...
require (
	...
	github.com/blueprint-uservices/blueprint/examples/threechain2/workflow v0.0.0
)
...
replace github.com/blueprint-uservices/blueprint/examples/threechain2/workflow => ../workflow
