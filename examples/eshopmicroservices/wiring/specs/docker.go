...
import (
	...
	"github.com/blueprint-uservices/blueprint/examples/eshopmicroservices/workflow/eshopmicroservices"
...
func makeDockerSpec(spec wiring.WiringSpec) ([]string, error) {
	...
	catalog_service := workflow.Service[eshopmicroservices.CatalogService](spec, "catalog_service", catalog_db)
	...
	discount_service := workflow.Service[eshopmicroservices.DiscountService](spec, "discount_service", discount_db)
	...
	basket_service := workflow.Service[eshopmicroservices.BasketService](spec, "basket_service", basket_db, order_queue, discount_service)
	...
	order_service := workflow.Service[eshopmicroservices.OrderService](spec, "order_service", order_db, order_queue)
	...
	web_app := workflow.Service[eshopmicroservices.WebApp](spec, "web_app", basket_service, catalog_service, discount_service, order_service)
