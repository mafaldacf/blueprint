...
func makeDockerSpec(spec wiring.WiringSpec) ([]string, error) {
	...
	employee_service := workflow.Service[app_constraints_specialization.EmployeeService](spec, "employee_service", freelancer_service, fulltime_service, employees_db)
	...
	frontend := workflow.Service[app_constraints_specialization.Frontend](spec, "frontend", employee_service, freelancer_service, fulltime_service)
