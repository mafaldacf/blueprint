...
func NewEmployeeServiceImpl(ctx context.Context, freelancerService FreelancerService, fulltimeService FulltimeService, employeesDB backend.NoSQLDatabase) (EmployeeService, error) {
	s := &EmployeeServiceImpl{freelancerService: freelancerService, fulltimeService: fulltimeService, employeesDB: employeesDB}
	return s, nil
}
