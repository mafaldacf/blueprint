...
func NewFrontendImpl(ctx context.Context, employeeService EmployeeService, freelancerService FreelancerService, fulltimeService FulltimeService) (Frontend, error) {
	return &FrontendImpl{employeeService: employeeService, freelancerService: freelancerService, fulltimeService: fulltimeService}, nil
}
