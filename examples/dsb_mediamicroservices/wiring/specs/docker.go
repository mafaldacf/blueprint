...
func makeDockerSpec(spec wiring.WiringSpec) ([]string, error) {
	...
	review_storage_service := workflow.Service[mediamicroservices.ReviewStorageService](spec, "review_storage_service", review_storage_db, review_storage_cache)
	...
	user_review_service := workflow.Service[mediamicroservices.UserReviewService](spec, "user_review_service", user_review_db, user_review_cache, review_storage_service)
	...
	movie_review_service := workflow.Service[mediamicroservices.MovieReviewService](spec, "movie_review_service", movie_review_db, movie_review_cache, review_storage_service)
	...
	compose_review_service := workflow.Service[mediamicroservices.ComposeReviewService](spec, "compose_review_service", compose_review_cache, review_storage_service, user_review_service, movie_review_service)
	...
	rating_service := workflow.Service[mediamicroservices.RatingService](spec, "rating_service", rating_cache, compose_review_service)
	rating_ctr := applyDockerDefaults(spec, rating_service, "rating_ctr", "rating_container")
	containers = append(containers, rating_ctr)

	text_service := workflow.Service[mediamicroservices.TextService](spec, "text_service", compose_review_service)
	text_ctr := applyDockerDefaults(spec, text_service, "text_ctr", "text_container")
	containers = append(containers, text_ctr)
	
	unique_id_service := workflow.Service[mediamicroservices.UniqueIdService](spec, "unique_id_service", compose_review_service)
	...
	user_service := workflow.Service[mediamicroservices.UserService](spec, "user_service", user_db, user_cache, compose_review_service)
	user_ctr := applyDockerDefaults(spec, user_service, "user_ctr", "user_container")
	containers = append(containers, user_ctr)

	movieid_service := workflow.Service[mediamicroservices.MovieIdService](spec, "movieid_service", movieid_db, movieid_cache, compose_review_service, rating_service)
	...
	movieinfo_service := workflow.Service[mediamicroservices.MovieInfoService](spec, "movieinfo_service", movieinfo_db, movieinfo_cache, socialgraph_db)
	...
	castinfo_service := workflow.Service[mediamicroservices.CastInfoService](spec, "castinfo_service", castinfo_db, castinfo_cache)
	...
	plot_service := workflow.Service[mediamicroservices.PlotService](spec, "plot_service", plot_db, plot_cache)
	plot_ctr := applyDockerDefaults(spec, plot_service, "plot_ctr", "plot_container")
	containers = append(containers, plot_ctr)

	page_service := workflow.Service[mediamicroservices.PageService](spec, "page_service", movieinfo_service, movie_review_service, castinfo_service, plot_service)
	page_ctr := applyDockerDefaults(spec, page_service, "page_proc", "page_container")
	containers = append(containers, page_ctr)

	api_service := workflow.Service[mediamicroservices.APIService](spec, "api_service", user_service, text_service, movieid_service, unique_id_service, movieinfo_service, castinfo_service, plot_service, page_service)
