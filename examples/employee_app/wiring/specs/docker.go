...
import (
	...
	"github.com/blueprint-uservices/blueprint/examples/employee_app/workflow/employee_app"
...
func makeDockerSpec(spec wiring.WiringSpec) ([]string, error) {
	...
	freelancer_service := workflow.Service[employee_app.FreelancerService](spec, "freelancer_service", freelancers_db)
	...
	fulltime_service := workflow.Service[employee_app.FulltimeService](spec, "fulltime_service", fulltimes_db)
	...
	intern_service := workflow.Service[employee_app.InternService](spec, "intern_service", interns_db)
	...
	employee_service := workflow.Service[employee_app.EmployeeService](spec, "employee_service", freelancer_service, fulltime_service, intern_service, employees_db)
	...
	frontend := workflow.Service[employee_app.Frontend](spec, "frontend", employee_service, freelancer_service, fulltime_service, intern_service)
