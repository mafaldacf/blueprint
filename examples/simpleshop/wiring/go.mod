module github.com/blueprint-uservices/blueprint/examples/simpleshop/wiring

go 1.22.4

require github.com/blueprint-uservices/blueprint/examples/simpleshop/workflow v0.0.0
...
replace github.com/blueprint-uservices/blueprint/examples/simpleshop/workflow => ../workflow
