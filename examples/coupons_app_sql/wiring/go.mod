module github.com/blueprint-uservices/blueprint/examples/coupons_app_sql/wiring
...
require (
	...
	github.com/blueprint-uservices/blueprint/examples/coupons_app_sql/workflow v0.0.0
)
...
replace github.com/blueprint-uservices/blueprint/examples/coupons_app_sql/workflow => ../workflow
