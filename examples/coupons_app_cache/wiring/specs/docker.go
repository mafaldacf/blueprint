...
import (
	...
	"github.com/blueprint-uservices/blueprint/examples/coupons_app_cache/workflow/coupons_app_cache"
...
func makeDockerSpec(spec wiring.WiringSpec) ([]string, error) {
	...
	student_service := workflow.Service[coupons_app_cache.StudentService](spec, "student_service", students_db)
	...
	coupon_service := workflow.Service[coupons_app_cache.CouponService](spec, "coupon_service", coupons_db)
	...
	frontend := workflow.Service[coupons_app_cache.Frontend](spec, "frontend", student_service, coupon_service)
