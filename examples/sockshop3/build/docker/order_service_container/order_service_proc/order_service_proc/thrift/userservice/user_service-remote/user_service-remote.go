...
var _ = userservice.GoUnusedProtection__

func Usage() {
  fmt.Fprintln(os.Stderr, "Usage of ", os.Args[0], " [-h host:port] [-u url] [-f[ramed]] function [arg1 [arg2...]]:")
  flag.PrintDefaults()
  fmt.Fprintln(os.Stderr, "\nFunctions:")
  fmt.Fprintln(os.Stderr, "  UserService_Delete_Response Delete(UserService_Delete_Request req)")
  fmt.Fprintln(os.Stderr, "  UserService_GetAddresses_Response GetAddresses(UserService_GetAddresses_Request req)")
  fmt.Fprintln(os.Stderr, "  UserService_GetCards_Response GetCards(UserService_GetCards_Request req)")
  fmt.Fprintln(os.Stderr, "  UserService_GetUsers_Response GetUsers(UserService_GetUsers_Request req)")
  fmt.Fprintln(os.Stderr, "  UserService_Login_Response Login(UserService_Login_Request req)")
  fmt.Fprintln(os.Stderr, "  UserService_PostAddress_Response PostAddress(UserService_PostAddress_Request req)")
  fmt.Fprintln(os.Stderr, "  UserService_PostCard_Response PostCard(UserService_PostCard_Request req)")
  fmt.Fprintln(os.Stderr, "  UserService_PostUser_Response PostUser(UserService_PostUser_Request req)")
  fmt.Fprintln(os.Stderr, "  UserService_Register_Response Register(UserService_Register_Request req)")
  fmt.Fprintln(os.Stderr)
  os.Exit(0)
}
...
func main() {
  ...
  case "Delete":
    ...
    argvalue0 := userservice.NewUserService_Delete_Request()
  ...
  case "GetAddresses":
    if flag.NArg() - 1 != 1 {
      fmt.Fprintln(os.Stderr, "GetAddresses requires 1 args")
      flag.Usage()
    }
    arg50 := flag.Arg(1)
    ...
    argvalue0 := userservice.NewUserService_GetAddresses_Request()
    ...
    value0 := argvalue0
    fmt.Print(client.GetAddresses(context.Background(), value0))
    fmt.Print("\n")
    break
  case "GetCards":
    if flag.NArg() - 1 != 1 {
      fmt.Fprintln(os.Stderr, "GetCards requires 1 args")
      flag.Usage()
    }
    arg56 := flag.Arg(1)
    ...
    argvalue0 := userservice.NewUserService_GetCards_Request()
    ...
    value0 := argvalue0
    fmt.Print(client.GetCards(context.Background(), value0))
    fmt.Print("\n")
    break
  case "GetUsers":
    if flag.NArg() - 1 != 1 {
    ...
    argvalue0 := userservice.NewUserService_GetUsers_Request()
  ...
  case "Login":
    ...
    argvalue0 := userservice.NewUserService_Login_Request()
  ...
  case "PostAddress":
    if flag.NArg() - 1 != 1 {
      fmt.Fprintln(os.Stderr, "PostAddress requires 1 args")
      flag.Usage()
    }
    arg74 := flag.Arg(1)
    ...
    argvalue0 := userservice.NewUserService_PostAddress_Request()
    ...
    value0 := argvalue0
    fmt.Print(client.PostAddress(context.Background(), value0))
    fmt.Print("\n")
    break
  case "PostCard":
    if flag.NArg() - 1 != 1 {
      fmt.Fprintln(os.Stderr, "PostCard requires 1 args")
      flag.Usage()
    }
    arg80 := flag.Arg(1)
    ...
    argvalue0 := userservice.NewUserService_PostCard_Request()
    ...
    value0 := argvalue0
    fmt.Print(client.PostCard(context.Background(), value0))
    fmt.Print("\n")
    break
  case "PostUser":
    if flag.NArg() - 1 != 1 {
    ...
    argvalue0 := userservice.NewUserService_PostUser_Request()
  ...
  case "Register":
    ...
    argvalue0 := userservice.NewUserService_Register_Request()
