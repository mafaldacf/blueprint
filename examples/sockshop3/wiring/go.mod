module github.com/blueprint-uservices/blueprint/examples/sockshop3/wiring
...
require github.com/blueprint-uservices/blueprint/examples/sockshop3/workflow v0.0.0
