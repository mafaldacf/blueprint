...
func makeDockerSpec(spec wiring.WiringSpec) ([]string, error) {
	...
	user_service := workflow.Service[trainticket.UserService](spec, "user_service", user_db)
	...
	contacts_service := workflow.Service[trainticket.ContactsService](spec, "contacts_service", contacts_db)
	...
	price_service := workflow.Service[trainticket.PriceService](spec, "price_service", price_db)
	...
	station_service := workflow.Service[trainticket.StationService](spec, "station_service", station_db)
	...
	news_service := workflow.Service[trainticket.NewsService](spec, "news_service")
	...
	assurance_service := workflow.Service[trainticket.AssuranceService](spec, "assurance_service", assurance_db)
	...
	config_service := workflow.Service[trainticket.ConfigService](spec, "config_service", config_db)
	...
	consignprice_service := workflow.Service[trainticket.ConsignPriceService](spec, "consignprice_service", consignprice_db)
	...
	trainfood_service := workflow.Service[trainticket.TrainFoodService](spec, "trainfood_service", trainfood_db)
	...
	train_service := workflow.Service[trainticket.TrainService](spec, "train_service", train_db)
	...
	route_service := workflow.Service[trainticket.RouteService](spec, "route_service", route_db)
	...
	stationfood_service := workflow.Service[trainticket.StationFoodService](spec, "stationfood_service", stationfood_db)
	...
	delivery_service := workflow.Service[trainticket.DeliveryService](spec, "delivery_service", delivery_queue, delivery_db)
	...
	payment_service := workflow.Service[trainticket.PaymentService](spec, "payment_service", payment_db, money_db)
	...
	consign_service := workflow.Service[trainticket.ConsignService](spec, "consign_price_service", consignprice_service, consign_db)
	...
	order_service := workflow.Service[trainticket.OrderService](spec, "order_service", order_db)
	...
	seat_service := workflow.Service[trainticket.SeatService](spec, "seat_service", order_service, config_service)
	...
	food_service := workflow.Service[trainticket.FoodService](spec, "food_service", food_db, delivery_queue, trainfood_service, "travel_service.client", stationfood_service)
	...
	inside_payment_service := workflow.Service[trainticket.InsidePaymentService](spec, "inside_payment_service", inside_payment_db, payment_service, order_service)
	...
	execute_service := workflow.Service[trainticket.ExecuteService](spec, "execute_service", order_service)
	...
	basic_service := workflow.Service[trainticket.BasicService](spec, "basic_service", station_service, train_service, route_service, price_service)
	...
	allServices = append(allServices, order_db)
	travel_service := workflow.Service[trainticket.TravelService](spec, "travel_service", basic_service, seat_service, route_service, train_service, travel_db)
	...
	preserve_service := workflow.Service[trainticket.PreserveService](spec, "preserve_service",
	...
	cancel_service := workflow.Service[trainticket.CancelService](spec, "cancel_service", order_service, user_service, inside_payment_service, email_queue)
	...
	rebook_service := workflow.Service[trainticket.RebookService](spec, "rebook_service", seat_service, travel_service, order_service, train_service, route_service, inside_payment_service)
	...
	admin_basic_info_service := workflow.Service[trainticket.AdminBasicInfoService](spec, "admin_basic_info_service", station_service, train_service, config_service, contacts_service, price_service)
	...
	admin_order_service := workflow.Service[trainticket.AdminOrderService](spec, "admin_order_service", order_service)
	...
	admin_route_service := workflow.Service[trainticket.AdminRouteService](spec, "admin_route_service", route_service)
	...
	admin_travel_service := workflow.Service[trainticket.AdminTravelService](spec, "admin_travel_service", travel_service)
	...
	admin_user_service := workflow.Service[trainticket.AdminUserService](spec, "admin_user_service", user_service)
	...
	dashboard := workflow.Service[trainticket.Dashboard](spec, "dashboard",
