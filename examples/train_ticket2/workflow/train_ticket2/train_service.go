...
func NewTrainServiceImpl(ctx context.Context, db backend.NoSQLDatabase) (TrainService, error) {
...
func (ts *TrainServiceImpl) Update(ctx context.Context, ttype TrainType) (bool, error) {
	...
	query := bson.D{{Key: "ID", Value: ttype.ID}}
...
func (ts *TrainServiceImpl) Delete(ctx context.Context, id string) (bool, error) {
	...
	err = coll.DeleteOne(ctx, bson.D{{Key: "ID", Value: id}})
	if err != nil {
		return false, err
	}
	return true, nil
