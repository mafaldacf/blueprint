...
func NewFrontendImpl(ctx context.Context, movieService MovieService, plotService PlotService, priceService PriceService, routeService RouteService) (Frontend, error) {
	f := &FrontendImpl{movieService: movieService, plotService: plotService, priceService: priceService}
	return f, nil
}
