module github.com/blueprint-uservices/blueprint/examples/dsb_hotel2/wiring
...
replace github.com/blueprint-uservices/blueprint/examples/dsb_hotel2/workflow => ../workflow
