module github.com/blueprint-uservices/blueprint/examples/dsb_sn2/wiring

go 1.22.4

require github.com/blueprint-uservices/blueprint/examples/dsb_sn2/workflow v0.0.0
...
replace github.com/blueprint-uservices/blueprint/examples/dsb_sn2/workflow => ../workflow
