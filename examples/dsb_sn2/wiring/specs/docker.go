...
func makeDockerSpec(spec wiring.WiringSpec) ([]string, error) {
	...
	socialgraph_cache := memcached.Container(spec, "socialgraph_cache")
	socialgraph_db := mongodb.Container(spec, "socialgraph_db")
	...
	allServices = append(allServices, socialgraph_cache)
	allServices = append(allServices, socialgraph_db)
	...
	urlshorten_service := workflow.Service[socialnetwork2.UrlShortenService](spec, "urlshorten_service", urlshorten_db)
	...
	usermention_service := workflow.Service[socialnetwork2.UserMentionService](spec, "usermention_service", user_cache, user_db)
	...
	post_storage_service := workflow.Service[socialnetwork2.PostStorageService](spec, "post_storage_service", post_cache, post_db)
	...
	media_service := workflow.Service[socialnetwork2.MediaService](spec, "media_service")
	...
	uniqueId_service := workflow.Service[socialnetwork2.UniqueIdService](spec, "uniqueid_service")
	...
	userid_service := workflow.Service[socialnetwork2.UserIDService](spec, "userid_service", user_cache, user_db)
	...
	socialgraph_service := workflow.Service[socialnetwork2.SocialGraphService](spec, "socialgraph_service", socialgraph_cache, socialgraph_db, userid_service)
	...
	hometimeline_service := workflow.Service[socialnetwork2.HomeTimelineService](spec, "hometimeline_service", hometimeline_cache, post_storage_service, socialgraph_service)
	...
	// Define user service
	user_service := workflow.Service[socialnetwork2.UserService](spec, "user_service", user_cache, user_db, socialgraph_service, "secret")
	...
	// Define text service
	text_service := workflow.Service[socialnetwork2.TextService](spec, "text_service", urlshorten_service, usermention_service)
	...
	usertimeline_service := workflow.Service[socialnetwork2.UserTimelineService](spec, "usertimeline_service", usertimeline_cache, usertimeline_db, post_storage_service)
	...
	composepost_service := workflow.Service[socialnetwork2.ComposePostService](spec, "composepost_service", post_storage_service, usertimeline_service, user_service, uniqueId_service, media_service, text_service, hometimeline_service)
	...
	wrk2api_service := workflow.Service[socialnetwork2.Wrk2APIService](spec, "wrk2api_service", user_service, composepost_service, usertimeline_service, hometimeline_service, socialgraph_service)
